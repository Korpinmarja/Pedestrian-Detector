...
!function (e, t) {
    if (void 0 === e && void 0 !== window && (e = window),
        "function" == typeof define && define.amd) define(["jquery"],
            function (e) {
                return t(e)
            });
    else if ("object" == typeof module && module.exports) {
        var n = t(require("jquery")); module.exports = n
    }
    else t(e.jquery)
}
    (this, function (e) {
    ...
    function u(e, t) {
        var n, s, a, r, i, o, l, u, d, c, h, f = t && t.split("/"),
            m = _.map, g = m && m["*"] || {};
        if (e) {
            for (i = (e = e.split("/")).length - 1,
                _.nodeIdCompat && k.test(e[i]) && (e[i] = e[i].replace(k, "")),
                "." === e[0].charAt(0) && f && (e = f.slice(0, f.length - 1).concat(e)),
                d = 0; d < e.length; d++)
                if ("." === (h = e[d])) e.splice(d, 1),
                    d -= 1; else if (".." === h) {
                        if (0 === d || 1 === d && ".." === e[2] || ".." === e[d - 1]) continue; 0 < d && (e.splice(d - 1, 2), d -= 2)
                    } e = e.join("/")
        }
        if ((f || g) && m) {
        ...
        return function (e) { p[t] = e }
    } function b(e) {
        if (w(y, e)) {
            var t = y[e]; delete y[e], v[e] = !0, r.apply(f, t)
        }
        if (!w(p, e) && !w(v, e)) throw new Error("No " + e);
        return p[e]
    } function d(e) {
        var t, n = e ? e.indexOf("!") : -1; return -1 < n && (t = e.substring(0, n),
        ...
        return (U = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
            ...
            function (e) { return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e })(e)
    } function U(e) {
